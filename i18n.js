...
(function initializeI18n(global) {
  ...
  const staticTranslations = {
    ...
    "Outputs are for hypothesis generation and sensitivity analysis, not forecasts or management advice. All calculations run locally in the browser. No company inputs are uploaded, making the project suitable for private internal exploration and independent review of every formula.": "輸出結果用於建立假設與敏感度分析，不是預測或管理建議。所有計算皆在瀏覽器本機執行，不會上傳企業輸入，因此適合內部隱私研究，也方便獨立檢視每一項公式。",
  ...
  const messages = {
    en: {
      ...
      "verdict.pilot": "Validate with a controlled pilot",
