...
(function initializeI18n(global) {
  ...
  const staticTranslations = {
    ...
    "Outputs are for hypothesis generation and sensitivity analysis, not forecasts or management advice. Calculator inputs are processed locally by the model and are not intentionally uploaded by the calculator.": "輸出結果用於建立假設與敏感度分析，不是預測或管理建議。試算輸入由模型在本機處理，試算器不會主動上傳企業輸入。",
    ...
    "AI ROI after rollout": "AI 導入成熟後 ROI",
    ...
    "Theoretical released productivity": "理論可釋放生產力",
  ...
  const messages = {
    en: {
      ...
      "uncertainty.roi": "AI ROI after rollout {roi} · Year-one cash {cash}",
      ...
      "verdict.revenue.label": "Revenue lift required",
      "verdict.revenue.note": "{growth} of current annual revenue",
      "verdict.revenue.none": "No additional revenue gap under current assumptions",
      "verdict.revenue.unavailable": "Revenue gap cannot be estimated from current inputs",
      ...
      "warning.demandCap": "The AI-enabled capacity is larger than the demand you validated, so the model only counts revenue up to that demand limit.",
      ...
      "analysis.aiPositive": "After the AI program has stabilized, AI adds approximately {profit} of annual operating profit versus the no-AI baseline, for an ROI of {roi}.",
      "analysis.aiNegative": "After the AI program has stabilized, AI reduces annual operating profit by approximately {profit} versus the no-AI baseline, producing an ROI of {roi}.",
    ...
    "zh-TW": {
      ...
      "uncertainty.npv": "{value} NPV",
      "uncertainty.roi": "AI 導入成熟後 ROI {roi} · 第一年現金流 {cash}",
      ...
      "verdict.revenue.label": "AI 需要補上的營收",
      "verdict.revenue.note": "相當於目前年度營收 {growth}",
      "verdict.revenue.none": "目前假設下沒有額外營收缺口",
      "verdict.revenue.unavailable": "目前輸入無法估算營收缺口",
      ...
      "warning.demandCap": "AI 可能創造的產能高於已確認的市場需求，因此模型只把可驗證需求內的部分算成新增營收。",
      ...
      "analysis.aiPositive": "AI 導入成熟後，相較未導入基準每年增加約 {profit} 的營業利益，ROI 為 {roi}。",
      "analysis.aiNegative": "AI 導入成熟後，相較未導入基準每年降低約 {profit} 的營業利益，ROI 為 {roi}。",
